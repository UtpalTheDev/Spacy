...
var url="https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?sol=1000&page=1&api_key="+api_key;
...
function clickfunc() {
    ...
    url="https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?sol="+sol+"&api_key="+api_key;
    var html="<div>";
    fetch(url)
    .then(response => response.json() )
    .then(json=>
